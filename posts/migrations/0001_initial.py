# Generated by Django 3.2 on 2023-09-04 14:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.CharField(choices=[('general', 'General'), ('science_technology', 'Science & Technology'), ('culture', 'Culture'), ('faith_religion', 'Faith & Religion'), ('politics', 'Politics'), ('sports', 'Sports'), ('business_finance', 'Business & Finance'), ('news', 'News'), ('music', 'Music'), ('history', 'History'), ('philosophy', 'Philosophy'), ('fiction', 'Fiction'), ('health_wellness', 'Health & Wellness'), ('art', 'Art'), ('design', 'Design'), ('education', 'Education'), ('humour', 'Humour'), ('literature', 'Literature')], default='general', max_length=50)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
